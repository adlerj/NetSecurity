...
HistoryGenerator.prototype.showError = function() {
  this.container.innerHTML = "<div class='card shadow'><div class='redline'></div><div class='inner-card'><div class='iconandtext'><img class='iticon' src='images/sad.png' alt='Calendar'/><h1 class='ittext'>No Results!</h1></div><div class='error-space'></div></div></div>";
}
